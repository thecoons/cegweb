...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/article')) {
            // ceg_article_create
            if (rtrim($pathinfo, '/') === '/article/create') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'ceg_article_create');
                }
            ...
            if (0 === strpos($pathinfo, '/article/delete') && preg_match('#^/article/delete/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ceg_article_delete')), array (  '_controller' => 'CEG\\ArticleBundle\\Controller\\DefaultController::deleteArticleAction',));
            }

            // ceg_article_update
            if (0 === strpos($pathinfo, '/article/update') && preg_match('#^/article/update/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ceg_article_update')), array (  '_controller' => 'CEG\\ArticleBundle\\Controller\\DefaultController::updateArticleAction',));
            }
            ...
            // ceg_image_delete
            if (0 === strpos($pathinfo, '/article/deleteFile') && preg_match('#^/article/deleteFile/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'ceg_image_delete')), array (  '_controller' => 'CEG\\ArticleBundle\\Controller\\DefaultController::deleteImageAction',));
            }

        }

        // ceg_application_homepage
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'ceg_application_homepage');
            }

            return array (  '_controller' => 'CEG\\ApplicationBundle\\Controller\\DefaultController::indexAction',  '_route' => 'ceg_application_homepage',);
        }
