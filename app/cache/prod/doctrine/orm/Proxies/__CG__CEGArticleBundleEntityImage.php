 ...
 */
class Image extends \CEG\ArticleBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CEG\\ArticleBundle\\Entity\\Image' . "\0" . 'id', '' . "\0" . 'CEG\\ArticleBundle\\Entity\\Image' . "\0" . 'article', '' . "\0" . 'CEG\\ArticleBundle\\Entity\\Image' . "\0" . 'url', '' . "\0" . 'CEG\\ArticleBundle\\Entity\\Image' . "\0" . 'alt', '' . "\0" . 'CEG\\ArticleBundle\\Entity\\Image' . "\0" . 'description', '' . "\0" . 'CEG\\ArticleBundle\\Entity\\Image' . "\0" . 'file', '' . "\0" . 'CEG\\ArticleBundle\\Entity\\Image' . "\0" . 'tempFilename');
        }
